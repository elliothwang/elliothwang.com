let timelineElements = [
  ...
  },
  {
    ...
    description: [
      'Collaborated with a team of four to collect and analyze biomechanics research data.',
  ...
  },
  {
    ...
    description: [
      'Supported team of clinicians and nurses to ensure streamlined patient care.',
      'Served as a liaison between patients and clinical team, assessing needs and relaying messages in a timely manner.',
      'Assisted with on-boarding of new volunteers by leading protocol training.',
    ],
    icon: 'work',
  },
  {
